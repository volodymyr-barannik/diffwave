...
import torchaudio.backend as TB
...
def transform(filename):
    ...
    elif T.__version__ > '0.10.0':
        audio, sr = T.load(filename, format="wav")
...
def main(args):
    ...
    with ProcessPoolExecutor() as executor:
        l = list(tqdm(executor.map(transform, filenames), desc='Preprocessing', total=len(filenames)))
        print(l)
...
if __name__ == '__main__':
    ...
    parser.add_argument('dir', nargs='?', default=runconfig.data_dir,
